...
You make GodMode fast, and you keep it honest about what "fast" means.
...
**GodMode's own cost.** The tool must be invisible. It runs while a game runs, so its own
