...
namespace GamerGod.Core.Mutations;

/// <summary>
/// Whether a change is observable from inside a game process.
///
/// <para>
/// This is the load-bearing type in GamerGod. Charter Article I promises that a machine
/// running GamerGod is indistinguishable from a normal Windows install, as seen from inside
...
public enum MutationVisibility
{
    ...
    ///
    /// <para>
    /// Requires a <see cref="GamerGod.Core.Policy.ContactGrant"/>, which
    /// <see cref="GamerGod.Core.Policy.GameIntegrityPolicy"/> will not issue when kernel
