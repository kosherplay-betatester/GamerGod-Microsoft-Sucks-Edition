...
namespace GodMode.Windows.Native;

/// <summary>
/// GodMode's entire native surface.
///
/// <para>
/// This file is the audit surface for Charter Articles II and III. Every Win32 entry point
/// GodMode can reach is declared here and nowhere else, so a reviewer can verify in one
...
/// so that the whole solution compiles with <c>AllowUnsafeBlocks=false</c>. "GodMode
...
internal static class NativeMethods
{
    ...
    /// Read-only; the sole source of truth for <see cref="GodMode.Core.Hardware.ProcessorSnapshot"/>.
    /// </summary>
