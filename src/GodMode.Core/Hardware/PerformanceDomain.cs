...
public enum DomainClass
{
    ...
    /// <summary>Slower or smaller-cache cores. Where GodMode evicts background work to.</summary>
    Efficiency,
...
/// This is GodMode's universal replacement for vendor-specific concepts like "CCD",
