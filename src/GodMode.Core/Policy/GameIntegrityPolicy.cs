...
public enum ContactPreference
{
    ...
    /// <summary>
    /// The user has explicitly opted this title in. Contact is still refused unless GodMode
...
/// <summary>
/// The set of mutations GodMode is allowed to apply to a given title right now.
/// </summary>
    ...
    public string Explain()
    {
        ...
        return Assessment.Tier switch
        {
            AntiCheatTier.Kernel =>
                $"Ambient only for '{Title}': kernel anti-cheat detected. GodMode will not "
                + $"open a handle to this game. {Assessment.Explain()}",
            AntiCheatTier.Unknown =>
                $"Ambient only for '{Title}': no anti-cheat signature matched, which GodMode "
...
/// <summary>
/// Decides what GodMode may do to a title. The single choke point for Charter Article I.
/// </summary>
