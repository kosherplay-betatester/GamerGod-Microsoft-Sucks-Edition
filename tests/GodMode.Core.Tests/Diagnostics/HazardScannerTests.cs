...
namespace GodMode.Core.Tests.Diagnostics;
...
public sealed class HazardScannerTests
{
    ...
    public void Coexisting_hypervisors_are_flagged_as_a_launch_failure_cause()
    {
        ...
        Assert.Contains("GodMode did not cause", virt.Detail, StringComparison.Ordinal);
    }
    ...
    public void Missing_secure_boot_is_reported_as_a_launch_blocker_not_a_tweak()
    {
        ...
        Assert.Contains("GodMode will never turn these off", hazard.Remedy!, StringComparison.Ordinal);
    }
