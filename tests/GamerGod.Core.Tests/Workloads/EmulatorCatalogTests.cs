...
namespace GamerGod.Core.Tests.Workloads;
...
public sealed class EmulatorCatalogTests
{
    ...
    public void Native_refresh_rates_are_the_real_console_values_not_rounded_to_sixty()
    {
        ...
        // Rounding these to 60 would silently reintroduce the judder GamerGod exists to
...
public sealed class CompanionCatalogTests
{
    ...
    {
        // GamerGod never injects, but it can hand off to a tool that does. That has to be
